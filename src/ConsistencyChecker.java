                ...
                for (int i = 0; i <val.size() ; i++) {
                    ...
                    for (int j = i+1; j <val.size() ; j++) {
                        ...
                        if (!val1[1].equalsIgnoreCase(val2[1])) { //No point in comparing in the same abstract
                            ...
                            if(val1[0].equalsIgnoreCase(val2[0])&& val1[2].equalsIgnoreCase(val2[2])){ //ides are different but it is the same triple (Happens when articles are retracted)
                                continue;
                            }
                                ...
                                if (checkforThreashold(res, 0.05f) > 0) { //0.0005f
                                  //  max=Math.max(max,res);
                                   // System.out.println(res+" "+max);
                                    ...
                                    //TODO this is where the old confidances factor in (Search string: soyanna1 )
                                    float c1=Float.parseFloat(val1[3]);
                                    float c2=Float.parseFloat(val2[3]);

                                   // System.out.println();
                                   // System.out.println(res);
                                    confidence = Math.min(res*c1*c2*10,1.00000000f) + ""; //Added the confidance
